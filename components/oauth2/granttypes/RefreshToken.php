...
class RefreshToken extends BaseModel {
    ...
    public function getResponseData() {
        ...
        $refreshToken = \app\components\oauth2\models\RefreshToken::createRefreshToken([
            'client_id' => $this->client_id,
            'user_id' => $refreshToken->user_id,
    ...
    /**
     *
     * @return \app\components\oauth2\models\RefreshToken
     */
    public function getRefreshToken() {
        if (is_null($this->_refreshToken)) {
            ...
            if (!$this->_refreshToken = \app\components\oauth2\models\RefreshToken::findOne(['refresh_token' => $this->refresh_token])) {
