...
class User extends ActiveRecord implements IdentityInterface {
    ...
    public function rules() {
        return [
            [['nickname', 'password_hash', 'mobile'], 'required'],
            [['last_address_id', 'created_at', 'updated_at'], 'integer'],
            [['username', 'nickname', 'mobile', 'last_ip', 'last_device_type', 'last_device_id'], 'string', 'max' => 20],
     ...
     * @return boolean if username provided is valid for current user and hasn't been set
     */
